...
function addTransaction(source, amount) {
    ...
    addTransactionDom(Number(transaction.id), source, transaction.time, amount);
...
form.addEventListener("submit", event => {
    ...
    if (form.source.value.trim() === "" || form.amount.value === "") {
        return alert("Please type in the correct values");
    }    
...
// Function to fetch record from localstorage and display to the user
